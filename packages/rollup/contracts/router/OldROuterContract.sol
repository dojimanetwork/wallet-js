...
// TODO: @bhaagiKenpachi if this contract is being used rename this to Router
// @notice this contract is taken form: https://gitlab.com/thorchain/ethereum/eth-router/-/blob/f1e16d2b4c21857d77902169f85c289fe15b9a83/contracts/THORChain_Router.sol
contract OldRouter is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    address public RUNE;
    ...
    function initialize(address rune) public initializer {
