...
import {AccountBasedBaseToken} from "./AccountBasedBaseToken.sol";

contract AccountBasedToken is AccountBasedBaseToken, IERC20Metadata, StateSyncerVerifier, IStateReceiver {
