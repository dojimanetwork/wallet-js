...
//import "./TestChildBEP2.sol";
//
//contract TestChildBEP2Proxified is TestChildBEP2, Initializable {
//    constructor() TestChildBEP2(address(0x1), abi.encodePacked('TEST-12A'), '', '', 18) {}
//
//    function initialize(
...
//        require(_token.length != 0, 'ChildBEP2Proxified: token length cannot be zero');
//        token = _token;
//        _name = name;
//        _symbol = symbol;
//       // _decimals = decimals;
