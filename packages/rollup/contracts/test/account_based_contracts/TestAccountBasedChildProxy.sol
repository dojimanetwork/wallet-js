...
contract TestAccountBasedChildProxy is TestAccountBasedToken, Initializable {
    constructor() TestAccountBasedToken(address(0x1), abi.encodePacked('TEST-12A'), '', '', 18) {}
    ...
    // uint8 _decimals //@akhilpune: removed initialization of decimals
        ...
        require(_token.length != 0, 'Test Account Based Child Proxy: token length cannot be zero');
        token = _token;
        _name = name;
        _symbol = symbol;
        // _decimals = decimals;
