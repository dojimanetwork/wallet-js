...
contract OmniChainERC20 is ReentrancyGuard, AccessControl, IStateReceiver {
    ...
    constructor(address _xTokenAddress, address _outboundStateSender, address _stateSyncerVerifier) {
